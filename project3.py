...
url_user_recom_result = 'https://drive.google.com/file/d/1tc5p1CjvdoQaX_3kEDfHNyWINGOh4sOK/view?usp=sharing'
...
data_cleaned = pd.read_csv('product_data_processed.csv', index_col=0)
...
# def als_recommendation_for_user(customer_id):
#     customer_id = customer_id
#     product_recs = user_recommendation_result.loc[user_recommendation_result['customer_id']==customer_id,'product_id']
#     product_infos = data_product[data_product['item_id'].isin(product_recs)]
